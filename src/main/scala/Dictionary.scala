...
case class Dictionary(dictionary: HashSet[String]) {
  ...
  /** Checks the dictionary for the validity of a word */
	...
	def invalidWords(words: List[String]): List[String] =  words filterNot isValidWord
